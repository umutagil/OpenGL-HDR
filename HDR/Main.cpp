...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "HDR", nullptr, nullptr);
	...
	Shader hdrShader("shaders/hdr.vs", "shaders/hdr.frag");		
	...
	// Load textures
	woodTexture = loadTexture("images/textures/wood.jpg");
